...
### Quick Start
1. **Visit the live application:** [https://syllabus-to-calendar-kappa.vercel.app](https://syllabus-to-calendar-kappa.vercel.app)
...
- **Calendar View**: Only shows assignments with specific dates (exams, papers, projects)
- **List View**: Shows ALL extracted content including activities without specific dates
- **Activities**: Tasks without specific dates (readings, videos, discussions) appear only in List View
- **Tip**: Use List View to see complete syllabus content including all activities

#### **Google Calendar Integration**
- Google will show an "unverified app" warning - this is normal and **100% safe**
- The warning appears because the app hasn't completed Google's verification process
- Your data is secure and the integration works perfectly
- Click "Advanced" → "Go to [syllabus-to-calendar-kappa.vercel.app] (unsafe)" to proceed safely
...
#### **Event Types**
- **Assignments**: Papers, projects, case briefs (show on calendar)
- **Exams**: Midterms, finals, quizzes (show on calendar)
- **Readings**: Weekly readings, textbook chapters (list view only)
- **Activities**: Tasks without specific dates - readings, videos, discussions (list view only)

#### **Date Display**
- **Specific Date**: Event appears on calendar and in list view
- **"No Date"**: Event appears only in list view (readings, activities)
...
- **Target Audience:** Designed for law students and academic professionals
